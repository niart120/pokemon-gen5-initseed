...
mod tests {
    ...
    fn test_time_code_generation() {
        ...
        assert_eq!(
            TimeCodeGenerator::get_time_code(12 * 3600 + 30 * 60 + 45),
            0x12304500
        ); // 12:30:45
        assert_eq!(
            TimeCodeGenerator::get_time_code(23 * 3600 + 59 * 60 + 59),
            0x23595900
        ); // 23:59:59
    }
    ...
    fn test_time_code_hardware_variants() {
        ...
        // ハードウェア別の時刻コード生成テスト
        let ds_time_code =
            TimeCodeGenerator::get_time_code_for_hardware(12 * 3600 + 30 * 60 + 45, "DS");
        let ds_lite_time_code =
            TimeCodeGenerator::get_time_code_for_hardware(12 * 3600 + 30 * 60 + 45, "DS_LITE");
        let _3ds_time_code =
            TimeCodeGenerator::get_time_code_for_hardware(12 * 3600 + 30 * 60 + 45, "3DS");
        ...
        let morning_ds_code =
            TimeCodeGenerator::get_time_code_for_hardware(morning_time_index, "DS");
        let morning_3ds_code =
            TimeCodeGenerator::get_time_code_for_hardware(morning_time_index, "3DS");
    ...
    fn test_time_code_boundary_values() {
        ...
        // 正午前後
        assert_eq!(
            TimeCodeGenerator::get_time_code(11 * 3600 + 59 * 60 + 59),
            0x11595900
        ); // 11:59:59

...
ジャイアントホールは常時霧が発生しており、通常は「あまいかおり」が使えません。所定の手順で霧を晴らす必要があります。
...
![Generation Results Filter](./images/10-generation-results-filter.png)
---
...
例: メモした消費数が`18`の場合、レポートを18回書く、またはレポート5回+ペラップ13回等の組み合わせで達成可能です。
...
2. メタモンが出現したら、捕獲要員でHPを削るなどして用意したボールで捕獲する
3. 捕獲したメタモンのステータスを確認する
4. 目的の性格・ステータスと一致していれば成功。異なる場合は手順5.1からやり直す

| エンカウント | 捕獲 | 性格確認 | 個体値確認 |
|---|---|---|---|
| ![Encount Ditto](./images/11-encount-ditto.png) | ![Capture Ditto](./images/12-capture-ditto.png) | ![Check Ditto Nature](./images/13-check-ditto-nature.png) | ![Check Ditto Stats](./images/14-check-ditto-stats.png) |

...
const romParameters = {
  "B": {
    "JPN": {
      ...
      "vcountTimerRanges": [{ vcount: 0x60, timer0Min: 0xC79, timer0Max: 0xC7A }] as const
    },
    "KOR": {
      "nazo": [0x022167B0, 0x022168AC, 0x022168AC, 0x022168F8, 0x022168F8] as const,
      "vcountTimerRanges": [{ vcount: 0x60, timer0Min: 0xC84, timer0Max: 0xC85 }] as const
    },
    "USA": {
      "nazo": [0x022160B0, 0x022161AC, 0x022161AC, 0x022161F8, 0x022161F8] as const,
      "vcountTimerRanges": [{ vcount: 0x60, timer0Min: 0xC7B, timer0Max: 0xC7C }] as const
    },
    "GER": {
      "nazo": [0x02215FF0, 0x022160EC, 0x022160EC, 0x02216138, 0x02216138] as const,
      "vcountTimerRanges": [{ vcount: 0x5F, timer0Min: 0xC77, timer0Max: 0xC78 }] as const
    },
    "FRA": {
      "nazo": [0x02216030, 0x0221612C, 0x0221612C, 0x02216178, 0x02216178] as const,
      "vcountTimerRanges": [{ vcount: 0x5F, timer0Min: 0xC73, timer0Max: 0xC74 }] as const
    },
    "SPA": {
      "nazo": [0x02216070, 0x0221616C, 0x0221616C, 0x022161B8, 0x022161B8] as const,
      "vcountTimerRanges": [{ vcount: 0x60, timer0Min: 0xC86, timer0Max: 0xC87 }] as const
    },
    "ITA": {
      "nazo": [0x02215FB0, 0x022160AC, 0x022160AC, 0x022160F8, 0x022160F8] as const,
      "vcountTimerRanges": [{ vcount: 0x5F, timer0Min: 0xC6A, timer0Max: 0xC6B }] as const
    }
  },
  "W": {
    "JPN": {
      "nazo": [0x02215F30, 0x0221602C, 0x0221602C, 0x02216078, 0x02216078] as const,
      "vcountTimerRanges": [{ vcount: 0x5F, timer0Min: 0xC67, timer0Max: 0xC69 }] as const
    },
    "KOR": {
      "nazo": [0x022167B0, 0x022168AC, 0x022168AC, 0x022168F8, 0x022168F8] as const,
      "vcountTimerRanges": [{ vcount: 0x60, timer0Min: 0xC7B, timer0Max: 0xC7C }] as const
    ...
    "USA": {
      ...
      "vcountTimerRanges": [{ vcount: 0x60, timer0Min: 0xC7E, timer0Max: 0xC80 }] as const
    },
    "GER": {
      "nazo": [0x02216010, 0x0221610C, 0x0221610C, 0x02216158, 0x02216158] as const,
      "vcountTimerRanges": [{ vcount: 0x60, timer0Min: 0xC7A, timer0Max: 0xC7B }] as const
    },
    "FRA": {
      "nazo": [0x02216050, 0x0221614C, 0x0221614C, 0x02216198, 0x02216198] as const,
      "vcountTimerRanges": [{ vcount: 0x5F, timer0Min: 0xC6E, timer0Max: 0xC6F }] as const
    },
    "SPA": {
      "nazo": [0x02216070, 0x0221616C, 0x0221616C, 0x022161B8, 0x022161B8] as const,
      "vcountTimerRanges": [{ vcount: 0x5F, timer0Min: 0xC70, timer0Max: 0xC71 }] as const
    },
    "ITA": {
  ...
  "B2": {
    "JPN": {
      ...
      "vcountTimerRanges": [{ vcount: 0x82, timer0Min: 0x1102, timer0Max: 0x1108 }] as const
    },
    "KOR": {
      "nazo": [0x0209B60C, 0x0203A4D5, 0x02200750, 0x022007A4, 0x022007A4] as const,
      "vcountTimerRanges": [{ vcount: 0x82, timer0Min: 0x10EF, timer0Max: 0x10F4 }] as const
    },
    "USA": {
    ...
    "GER": {
      ...
      "vcountTimerRanges": [
        { vcount: 0x81, timer0Min: 0x10E5, timer0Max: 0x10E8 },
        { vcount: 0x82, timer0Min: 0x10E9, timer0Max: 0x10EC }
      ] as const
    },
    "FRA": {
      "nazo": [0x0209AF08, 0x02039DF9, 0x02200030, 0x02200084, 0x02200084] as const,
      "vcountTimerRanges": [{ vcount: 0x82, timer0Min: 0x10F4, timer0Max: 0x10F8 }] as const
    },
    "SPA": {
      "nazo": [0x0209AEA8, 0x02039DB9, 0x021FFFD0, 0x02200024, 0x02200024] as const,
      "vcountTimerRanges": [{ vcount: 0x82, timer0Min: 0x1101, timer0Max: 0x1106 }] as const
    },
    "ITA": {
      "nazo": [0x0209ADE8, 0x02039D69, 0x021FFF10, 0x021FFF64, 0x021FFF64] as const,
      "vcountTimerRanges": [
        { vcount: 0x82, timer0Min: 0x1107, timer0Max: 0x1109 },
        { vcount: 0x83, timer0Min: 0x1109, timer0Max: 0x110D }
      ] as const
    }
  },
  "W2": {
    "JPN": {
      ...
      "vcountTimerRanges": [{ vcount: 0x82, timer0Min: 0x10F5, timer0Max: 0x10FB }] as const
    },
    "KOR": {
      "nazo": [0x0209B62C, 0x0203A501, 0x02200770, 0x022007C4, 0x022007C4] as const,
      "vcountTimerRanges": [{ vcount: 0x81, timer0Min: 0x10E4, timer0Max: 0x10E9 }] as const
    },
    "USA": {
      "nazo": [0x0209AF28, 0x02039E15, 0x02200050, 0x022000A4, 0x022000A4] as const,
      "vcountTimerRanges": [{ vcount: 0x82, timer0Min: 0x10F2, timer0Max: 0x10F6 }] as const
    },
    "GER": {
      "nazo": [0x0209AE48, 0x02039D95, 0x021FFF70, 0x021FFFC4, 0x021FFFC4] as const,
      "vcountTimerRanges": [{ vcount: 0x82, timer0Min: 0x10E5, timer0Max: 0x10ED }] as const
    },
    "FRA": {
      "nazo": [0x0209AF28, 0x02039E25, 0x02200050, 0x022000A4, 0x022000A4] as const,
      "vcountTimerRanges": [{ vcount: 0x82, timer0Min: 0x10EC, timer0Max: 0x10F0 }] as const
    },
    "SPA": {
    ...
    "ITA": {
      ...
      "vcountTimerRanges": [{ vcount: 0x82, timer0Min: 0x10FF, timer0Max: 0x1104 }] as const
    }
  }
} as const;

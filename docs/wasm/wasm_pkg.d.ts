...
export class IdAdjustmentSearchIterator {
   ...
   * - 検索範囲を全て処理したらfinished=trueになる
   */
  next_batch(max_results: number, chunk_seconds: number): IdAdjustmentSearchResults;
  /**
   * コンストラクタ
   *
   * # Arguments
   ...
   */
  constructor(ds_config: DSConfigJs, segment: SegmentParamsJs, time_range: TimeRangeParamsJs, search_range: SearchRangeParamsJs, target_tid: number, target_sid: number, shiny_pid: number, game_mode: number);
  /**
   * 検索が完了したかどうか
   */
  readonly isFinished: boolean;
...
export class IdAdjustmentSearchResults {
   ...
   * 指定インデックスの結果を取得
   */
  get(index: number): IdAdjustmentSearchResult | undefined;
  /**
...
export interface InitOutput {
  ...
  readonly __wbg_idadjustmentsearchiterator_free: (a: number, b: number) => void;
  readonly __wbg_idadjustmentsearchresult_free: (a: number, b: number) => void;
  readonly __wbg_idadjustmentsearchresults_free: (a: number, b: number) => void;
  ...
  readonly idadjustmentsearchiterator_is_finished: (a: number) => number;
  readonly idadjustmentsearchiterator_new: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => void;
  readonly idadjustmentsearchiterator_next_batch: (a: number, b: number, c: number) => number;
  readonly idadjustmentsearchiterator_processed_seconds: (a: number) => number;
  readonly idadjustmentsearchiterator_progress: (a: number) => number;
  readonly idadjustmentsearchiterator_total_seconds: (a: number) => number;
  readonly idadjustmentsearchresult_hour: (a: number) => number;
  readonly idadjustmentsearchresult_lcg_seed_hex: (a: number, b: number) => void;
  readonly idadjustmentsearchresult_second: (a: number) => number;
  readonly idadjustmentsearchresult_shiny_type: (a: number) => number;
  readonly idadjustmentsearchresult_sid: (a: number) => number;
  readonly idadjustmentsearchresult_tid: (a: number) => number;
  readonly idadjustmentsearchresult_vcount: (a: number) => number;
  readonly idadjustmentsearchresults_get: (a: number, b: number) => number;
  readonly idadjustmentsearchresults_length: (a: number) => number;
  readonly idadjustmentsearchresults_to_array: (a: number) => number;
  ...
  readonly idadjustmentsearchresult_day: (a: number) => number;
  readonly idadjustmentsearchresult_key_code: (a: number) => number;
  ...
  readonly idadjustmentsearchresult_minute: (a: number) => number;
  readonly idadjustmentsearchresult_month: (a: number) => number;
  readonly idadjustmentsearchresult_timer0: (a: number) => number;
  readonly idadjustmentsearchresult_year: (a: number) => number;
  readonly idadjustmentsearchresults_processed_in_chunk: (a: number) => number;

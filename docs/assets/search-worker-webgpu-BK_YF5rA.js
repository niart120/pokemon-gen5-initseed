const Se={B:{JPN:{nazo:[35741456,35741708,35741708,35741784,35741784],vcountTimerRanges:[[96,3193,3194]]},KOR:{nazo:[35743664,35743916,35743916,35743992,35743992],vcountTimerRanges:[[96,3204,3205]]},USA:{nazo:[35741872,35742124,35742124,35742200,35742200],vcountTimerRanges:[[96,3195,3196]]},GER:{nazo:[35741680,35741932,35741932,35742008,35742008],vcountTimerRanges:[[95,3191,3192]]},FRA:{nazo:[35741744,35741996,35741996,35742072,35742072],vcountTimerRanges:[[95,3187,3188]]},SPA:{nazo:[35741808,35742060,35742060,35742136,35742136],vcountTimerRanges:[[96,3206,3207]]},ITA:{nazo:[35741616,35741868,35741868,35741944,35741944],vcountTimerRanges:[[95,3178,3179]]}},W:{JPN:{nazo:[35741488,35741740,35741740,35741816,35741816],vcountTimerRanges:[[95,3175,3177]]},KOR:{nazo:[35743664,35743916,35743916,35743992,35743992],vcountTimerRanges:[[96,3195,3196]]},USA:{nazo:[35741904,35742156,35742156,35742232,35742232],vcountTimerRanges:[[96,3198,3200]]},GER:{nazo:[35741712,35741964,35741964,35742040,35742040],vcountTimerRanges:[[96,3194,3195]]},FRA:{nazo:[35741776,35742028,35742028,35742104,35742104],vcountTimerRanges:[[95,3182,3183]]},SPA:{nazo:[35741808,35742060,35742060,35742136,35742136],vcountTimerRanges:[[95,3184,3185]]},ITA:{nazo:[35741648,35741900,35741900,35741976,35741976],vcountTimerRanges:[[96,3195,3196]]}},B2:{JPN:{nazo:[34187484,33790665,35649968,35650052,35650052],vcountTimerRanges:[[130,4354,4360]]},KOR:{nazo:[34190860,33793237,35653456,35653540,35653540],vcountTimerRanges:[[130,4335,4340]]},USA:{nazo:[34189032,33791465,35651600,35651684,35651684],vcountTimerRanges:[[130,4354,4360]]},GER:{nazo:[34188840,33791337,35651408,35651492,35651492],vcountTimerRanges:[[129,4325,4328],[130,4329,4332]]},FRA:{nazo:[34189064,33791481,35651632,35651716,35651716],vcountTimerRanges:[[130,4340,4344]]},SPA:{nazo:[34188968,33791417,35651536,35651620,35651620],vcountTimerRanges:[[130,4353,4358]]},ITA:{nazo:[34188776,33791337,35651344,35651428,35651428],vcountTimerRanges:[[130,4359,4361],[131,4361,4365]]}},W2:{JPN:{nazo:[34187516,33790709,3565e4,35650084,35650084],vcountTimerRanges:[[130,4341,4347]]},KOR:{nazo:[34190892,33793281,35653488,35653572,35653572],vcountTimerRanges:[[129,4324,4329]]},USA:{nazo:[34189096,33791509,35651664,35651748,35651748],vcountTimerRanges:[[130,4338,4342]]},GER:{nazo:[34188872,33791381,35651440,35651524,35651524],vcountTimerRanges:[[130,4325,4333]]},FRA:{nazo:[34189096,33791525,35651664,35651748,35651748],vcountTimerRanges:[[130,4332,4336]]},SPA:{nazo:[34189e3,33791461,35651568,35651652,35651652],vcountTimerRanges:[[130,4335,4340]]},ITA:{nazo:[34188840,33791381,35651408,35651492,35651492],vcountTimerRanges:[[130,4351,4356]]}}},ye=[["A",0],["B",1],["Select",2],["Start",3],["[→]",4],["[←]",5],["[↑]",6],["[↓]",7],["R",8],["L",9],["X",10],["Y",11]],k=ye.reduce((e,[t,r])=>(e[t]=r,e),{}),we=ye.length,Le=(1<<we)-1,xe=12287,Ue=[1<<k["[↑]"]|1<<k["[↓]"],1<<k["[←]"]|1<<k["[→]"],1<<k.Select|1<<k.Start|1<<k.L|1<<k.R];function ie(e,t){return Number.isFinite(e)?e&Le:0}function Ie(e){const t=ie(e);return xe^t}function Fe(e){const t=ie(e);for(const r of Ue)if((t&r)===r)return!0;return!1}function We(e){return Ie(e)}function ze(e){const t=ie(e),r=[];for(let o=0;o<we;o+=1)(t&1<<o)!==0&&r.push(o);const n=[],a=1<<r.length;for(let o=0;o<a;o+=1){let d=0;for(let i=0;i<r.length;i+=1)(o&1<<i)!==0&&(d|=1<<r[i]);Fe(d)||n.push((d^xe)>>>0)}return n}const Z=1e3,ce=60,Re=60,be=24,Ee=ce*Re,Ge=Ee*be,Pe=Ge*Z;function Ne(e){const t=e.timeRange;if(!t)throw new Error("timeRange is required for seed search");const r=ae("hour",t.hour,0,be-1),n=ae("minute",t.minute,0,Re-1),a=ae("second",t.second,0,ce-1),o=new Date(e.dateRange.startYear,e.dateRange.startMonth-1,e.dateRange.startDay,0,0,0),d=new Date(e.dateRange.endYear,e.dateRange.endMonth-1,e.dateRange.endDay,0,0,0),i=o.getTime(),c=d.getTime();if(i>c)throw new Error("開始日が終了日より後に設定されています");const l=Math.floor((c-i)/Pe)+1;if(l<=0)throw new Error("探索日数が検出できませんでした");const p=r.count*n.count*a.count;if(p<=0)throw new Error("時刻レンジの組み合わせ数が0です");const _=new Date(e.dateRange.startYear,e.dateRange.startMonth-1,e.dateRange.startDay,r.start,n.start,a.start,0);return{plan:{dayCount:l,combosPerDay:p,hourRangeStart:r.start,hourRangeCount:r.count,minuteRangeStart:n.start,minuteRangeCount:n.count,secondRangeStart:a.start,secondRangeCount:a.count,startDayTimestampMs:i},firstCombinationDate:_}}function de(e,t){const r=Math.max(e.minuteRangeCount,1),n=Math.max(e.secondRangeCount,1),a=Math.max(e.combosPerDay,1),o=Math.max(0,Math.trunc(t)),d=Math.floor(o/a),i=o-d*a,c=r*n,l=Math.floor(i/c),p=i-l*c,_=Math.floor(p/n),w=p-_*n,b=e.hourRangeStart+l,P=e.minuteRangeStart+_,C=e.secondRangeStart+w,v=e.startDayTimestampMs+d*Pe+b*Ee*Z+P*ce*Z+C*Z;return new Date(v)}function ae(e,t,r,n){if(!t)throw new Error(`${e} range is required for WebGPU search`);const a=Math.trunc(t.start),o=Math.trunc(t.end);if(Number.isNaN(a)||Number.isNaN(o))throw new Error(`${e} range must be numeric`);if(a<r||o>n)throw new Error(`${e} range must be within ${r} to ${n}`);if(a>o)throw new Error(`${e} range start must be <= end`);return{start:a,end:o,count:o-a+1}}const Ye=100663296,He=4294967295;function Ke(e,t=[],r){const{plan:n,firstCombinationDate:a}=Ne(e),o=Je(r),d=Ze(t),i=Xe(e,n,a),c=Ve(i,o),l=c.reduce((p,_)=>p+_.messageCount,0);return{segments:c,targetSeeds:d,timePlan:n,summary:{totalMessages:l,totalSegments:c.length,targetSeedCount:d.length,rangeSeconds:i.rangeSeconds},limits:o,conditions:e}}function Ve(e,t){const r=[];if(e.rangeSeconds<=0)return r;const n=Math.max(1,t.workgroupSize*t.maxWorkgroupsPerDispatch),a=Math.min(t.maxMessagesPerDispatch,n),o={startDayOfWeek:e.startDayOfWeek,macLower:e.macLower,data7Swapped:e.data7Swapped,hardwareType:e.hardwareType,nazoSwapped:e.nazoSwapped,startYear:e.startYear,startDayOfYear:e.startDayOfYear,hourRangeStart:e.hourRangeStart,hourRangeCount:e.hourRangeCount,minuteRangeStart:e.minuteRangeStart,minuteRangeCount:e.minuteRangeCount,secondRangeStart:e.secondRangeStart,secondRangeCount:e.secondRangeCount};let d=0,i=0;for(const c of e.keyCodes){const l=Q(c>>>0);for(const p of e.timer0Segments)for(let _=p.timer0Min;_<=p.timer0Max;_+=1){const w=p.vcount;let b=e.rangeSeconds,P=0;const C=Q((w&65535)<<16|_&65535);for(;b>0;){const E=Math.min(b,a),v=$e(E,t),s=()=>je({...o,timer0VcountSwapped:C,keyInputSwapped:l});r.push({id:`seg-${i}`,keyCode:c,timer0:_,vcount:w,messageCount:E,baseSecondOffset:P,globalMessageOffset:d,workgroupCount:v,getUniformWords:s}),b-=E,P+=E,d+=E,i+=1}}}return r}function $e(e,t){const r=Math.max(1,Math.ceil(e/t.workgroupSize)),n=Math.max(1,t.maxWorkgroupsPerDispatch);return Math.min(r,n)}function Je(e){if(!e?.limits)throw new Error("Seed search job limits are required for WebGPU execution");return qe(e.limits)}function qe(e){const t=G(e.workgroupSize,"workgroupSize"),r=G(e.maxWorkgroupsPerDispatch,"maxWorkgroupsPerDispatch"),n=G(e.candidateCapacityPerDispatch,"candidateCapacityPerDispatch"),a=G(e.maxMessagesPerDispatch,"maxMessagesPerDispatch"),o=G(e.maxDispatchesInFlight,"maxDispatchesInFlight"),d=Math.max(1,Math.floor(He/Math.max(1,t))),i=Math.min(r,d),c=Math.max(1,t*i),l=Math.min(a,c);return{workgroupSize:t,maxWorkgroupsPerDispatch:i,candidateCapacityPerDispatch:n,maxMessagesPerDispatch:l,maxDispatchesInFlight:o}}function Xe(e,t,r){const n=et(e),a=ze(e.keyInput);if(a.length===0)throw new Error("入力されたキー条件から生成できる組み合わせがありません");const o=tt(e,n);if(o.length===0)throw new Error("timer0の範囲が正しく設定されていません");const d=st(n.nazo),{macLower:i,data7Swapped:c}=nt(e.macAddress,Qe[e.hardware]),l=t.dayCount*t.combosPerDay;if(l<=0)throw new Error("探索対象の秒数が0以下です");return{rangeSeconds:l,timer0Segments:o,keyCodes:a,nazoSwapped:d,macLower:i,data7Swapped:c,hardwareType:ot(e.hardware),startYear:r.getFullYear(),startDayOfYear:ut(r),startDayOfWeek:r.getDay(),hourRangeStart:t.hourRangeStart,hourRangeCount:t.hourRangeCount,minuteRangeStart:t.minuteRangeStart,minuteRangeCount:t.minuteRangeCount,secondRangeStart:t.secondRangeStart,secondRangeCount:t.secondRangeCount}}function Ze(e){if(!e||e.length===0)return new Uint32Array(0);const t=[];for(const r of e)typeof r!="number"||!Number.isFinite(r)||t.push(r>>>0);return Uint32Array.from(t)}function G(e,t){if(!Number.isFinite(e)||e<=0)throw new Error(`${t} must be a positive finite number`);return Math.floor(e)}function je(e){const t=new Uint32Array(20);return t[0]=e.timer0VcountSwapped>>>0,t[1]=e.macLower>>>0,t[2]=e.data7Swapped>>>0,t[3]=e.keyInputSwapped>>>0,t[4]=e.hardwareType>>>0,t[5]=e.startYear>>>0,t[6]=e.startDayOfYear>>>0,t[7]=e.startDayOfWeek>>>0,t[8]=e.hourRangeStart>>>0,t[9]=e.hourRangeCount>>>0,t[10]=e.minuteRangeStart>>>0,t[11]=e.minuteRangeCount>>>0,t[12]=e.secondRangeStart>>>0,t[13]=e.secondRangeCount>>>0,t[14]=(e.nazoSwapped[0]??0)>>>0,t[15]=(e.nazoSwapped[1]??0)>>>0,t[16]=(e.nazoSwapped[2]??0)>>>0,t[17]=(e.nazoSwapped[3]??0)>>>0,t[18]=(e.nazoSwapped[4]??0)>>>0,t[19]=0,t}const Qe={DS:8,DS_LITE:6,"3DS":9};function et(e){const t=Se[e.romVersion];if(!t)throw new Error(`ROMバージョン ${e.romVersion} は未対応です`);const r=t[e.romRegion];if(!r)throw new Error(`ROMリージョン ${e.romRegion} は未対応です`);return{nazo:[...r.nazo],vcountTimerRanges:r.vcountTimerRanges.map(n=>[...n])}}function tt(e,t){const r=[],{timer0VCountConfig:{useAutoConfiguration:n,timer0Range:{min:a,max:o},vcountRange:{min:d,max:i}}}=e;if(!n){for(let l=d;l<=i;l+=1)r.push({timer0Min:a,timer0Max:o,vcount:l});return r}let c=null;for(let l=a;l<=o;l+=1){const p=rt(t,l);c&&c.vcount===p&&l===c.timer0Max+1?c.timer0Max=l:(c&&r.push(c),c={timer0Min:l,timer0Max:l,vcount:p})}return c&&r.push(c),r}function rt(e,t){for(const[r,n,a]of e.vcountTimerRanges)if(t>=n&&t<=a)return r;return e.vcountTimerRanges.length>0?e.vcountTimerRanges[0][0]:96}function nt(e,t){const r=at(e),n=(r[4]&255)<<8|r[5]&255,o=((r[0]&255|(r[1]&255)<<8|(r[2]&255)<<16|(r[3]&255)<<24)^Ye^t)>>>0;return{macLower:n,data7Swapped:Q(o)}}function at(e){const t=new Array(6).fill(0);for(let r=0;r<6;r+=1){const n=e[r]??0;t[r]=(Number(n)&255)>>>0}return t}function ot(e){switch(e){case"DS":return 0;case"DS_LITE":return 1;case"3DS":return 2;default:return 0}}function Q(e){return((e&255)<<24|(e>>>8&255)<<16|(e>>>16&255)<<8|e>>>24&255)>>>0}function st(e){const t=new Uint32Array(e.length);for(let r=0;r<e.length;r+=1)t[r]=Q(e[r]>>>0);return t}function ut(e){const t=new Date(e.getFullYear(),0,1),r=e.getTime()-t.getTime();return Math.floor(r/(1440*60*1e3))+1}class le{calculateHash(t){if(t.length!==16)throw new Error("Message must be exactly 16 32-bit words (64 bytes)");const r=1732584193,n=4023233417,a=2562383102,o=271733878,d=3285377520,i=new Array(80);for(let s=0;s<16;s++)i[s]=t[s];for(let s=16;s<80;s++)i[s]=this.leftRotate(i[s-3]^i[s-8]^i[s-14]^i[s-16],1);let c=r,l=n,p=a,_=o,w=d;for(let s=0;s<80;s++){let g;s<20?g=this.leftRotate(c,5)+(l&p|~l&_)+w+i[s]+1518500249&4294967295:s<40?g=this.leftRotate(c,5)+(l^p^_)+w+i[s]+1859775393&4294967295:s<60?g=this.leftRotate(c,5)+(l&p|l&_|p&_)+w+i[s]+2400959708&4294967295:g=this.leftRotate(c,5)+(l^p^_)+w+i[s]+3395469782&4294967295,w=_,_=p,p=this.leftRotate(l,30),l=c,c=g}const b=this.add32(r,c),P=this.add32(n,l),C=this.add32(a,p),E=this.add32(o,_),v=this.add32(d,w);return{h0:b,h1:P,h2:C,h3:E,h4:v}}leftRotate(t,r){return(t<<r|t>>>32-r)>>>0}add32(t,r){return(t+r&4294967295)>>>0}static hashToHex(t,r,n,a,o){return t.toString(16).padStart(8,"0")+r.toString(16).padStart(8,"0")+n.toString(16).padStart(8,"0")+a.toString(16).padStart(8,"0")+o.toString(16).padStart(8,"0")}}let L=null,N=null;async function it(){return L||N||(N=(async()=>{try{const e=await import("./wasm_pkg-DoV9kKKf.js");let t;if(typeof process<"u"&&!!process.versions?.node){const n=await import("./__vite-browser-external-9wXp6ZBx.js"),o=(await import("./__vite-browser-external-9wXp6ZBx.js")).join(process.cwd(),"src/wasm/wasm_pkg_bg.wasm");t={module_or_path:n.readFileSync(o)}}else t={module_or_path:new URL("/pokemon-gen5-initseed/assets/wasm_pkg_bg-B52NXIxA.wasm",import.meta.url)};return await e.default(t),L={BWGenerationConfig:e.BWGenerationConfig,PokemonGenerator:e.PokemonGenerator,SeedEnumerator:e.SeedEnumerator,EncounterType:e.EncounterType,GameVersion:e.GameVersion,GameMode:e.GameMode,EggSeedEnumeratorJs:e.EggSeedEnumeratorJs,ParentsIVsJs:e.ParentsIVsJs,GenerationConditionsJs:e.GenerationConditionsJs,EverstonePlanJs:e.EverstonePlanJs,IndividualFilterJs:e.IndividualFilterJs,TrainerIds:e.TrainerIds,GenderRatio:e.GenderRatio,StatRange:e.StatRange,EggBootTimingSearchResult:e.EggBootTimingSearchResult,EggBootTimingSearchIterator:e.EggBootTimingSearchIterator,DSConfigJs:e.DSConfigJs,SegmentParamsJs:e.SegmentParamsJs,TimeRangeParamsJs:e.TimeRangeParamsJs,SearchRangeParamsJs:e.SearchRangeParamsJs,IVBootTimingSearchIterator:e.IVBootTimingSearchIterator,IVBootTimingSearchResult:e.IVBootTimingSearchResult,IVBootTimingSearchResults:e.IVBootTimingSearchResults,calculate_game_offset:e.calculate_game_offset,sha1_hash_batch:e.sha1_hash_batch},L}catch(e){throw console.error("Failed to load WebAssembly module:",e),L=null,N=null,e}})(),N)}function ct(){if(!L)throw new Error("WebAssembly module not initialized. Call initWasm() first.");return L}function fe(){return L!==null}const dt={DS:8,DS_LITE:6,"3DS":9};class lt{sha1;useWasm=!1;constructor(){this.sha1=new le}async initializeWasm(){try{return await it(),this.useWasm=!0,!0}catch(t){return console.warn("WebAssembly initialization failed, falling back to TypeScript:",t),this.useWasm=!1,!1}}isUsingWasm(){return this.useWasm&&fe()}getWasmModule(){return ct()}setUseWasm(t){if(t&&!fe()){console.warn("Cannot enable WebAssembly: module not initialized");return}this.useWasm=t}getROMParameters(t,r){const n=Se[t];if(!n)return console.error(`ROM version not found: ${t}`),null;const a=n[r];return a?{nazo:[...a.nazo],vcountTimerRanges:a.vcountTimerRanges.map(o=>[...o])}:(console.error(`ROM region not found: ${r} for version ${t}`),null)}toLittleEndian32(t){return((t&255)<<24|(t>>>8&255)<<16|(t>>>16&255)<<8|t>>>24&255)>>>0}toLittleEndian16(t){return(t&255)<<8|t>>>8&255}getDayOfWeek(t,r,n){return new Date(t,r-1,n).getDay()}generateMessage(t,r,n,a,o){const d=this.getROMParameters(t.romVersion,t.romRegion);if(!d)throw new Error(`No parameters found for ${t.romVersion} ${t.romRegion}`);const i=new Array(16).fill(0);for(let R=0;R<5;R++)i[R]=this.toLittleEndian32(d.nazo[R]);i[5]=this.toLittleEndian32(n<<16|r);const c=t.macAddress[4]<<8|t.macAddress[5];i[6]=c;const l=t.macAddress[0]<<0|t.macAddress[1]<<8|t.macAddress[2]<<16|t.macAddress[3]<<24,p=100663296,_=dt[t.hardware],w=l^p^_;i[7]=this.toLittleEndian32(w);const b=a.getFullYear()%100,P=a.getMonth()+1,C=a.getDate(),E=this.getDayOfWeek(a.getFullYear(),P,C),v=Math.floor(b/10)*16+b%10,s=Math.floor(P/10)*16+P%10,g=Math.floor(C/10)*16+C%10,u=Math.floor(E/10)*16+E%10;i[8]=v<<24|s<<16|g<<8|u;const f=a.getHours(),h=a.getMinutes(),m=a.getSeconds(),S=(t.hardware==="DS"||t.hardware==="DS_LITE")&&f>=12?1:0,y=Math.floor(f/10)*16+f%10,x=Math.floor(h/10)*16+h%10,B=Math.floor(m/10)*16+m%10;i[9]=S<<30|y<<24|x<<16|B<<8|0,i[10]=0,i[11]=0;const D=o??We(t.keyInput);return i[12]=this.toLittleEndian32(D),i[13]=2147483648,i[14]=0,i[15]=416,i}calculateSeed(t){const r=this.sha1.calculateHash(t),n=BigInt(this.toLittleEndian32(r.h0)),o=BigInt(this.toLittleEndian32(r.h1))<<32n|n,c=o*0x5D588B656C078965n+0x269EC3n;return{seed:Number(c>>32n&0xFFFFFFFFn),hash:le.hashToHex(r.h0,r.h1,r.h2,r.h3,r.h4),lcgSeed:o}}parseTargetSeeds(t){const r=t.split(`
`).map(d=>d.trim()).filter(d=>d.length>0),n=[],a=[],o=new Set;return r.forEach((d,i)=>{try{let c=d.toLowerCase();if(c.startsWith("0x")&&(c=c.substring(2)),!/^[0-9a-f]{1,8}$/.test(c)){a.push({line:i+1,value:d,error:"Invalid hexadecimal format. Expected 1-8 hex digits."});return}const l=parseInt(c,16);if(o.has(l))return;o.add(l),n.push(l)}catch(c){const l=c instanceof Error?c.message:String(c);a.push({line:i+1,value:d,error:l||"Failed to parse as hexadecimal number."})}}),{validSeeds:n,errors:a}}getVCountForTimer0(t,r){for(const[n,a,o]of t.vcountTimerRanges)if(r>=a&&r<=o)return n;return t.vcountTimerRanges.length>0?t.vcountTimerRanges[0][0]:96}}const K=2,j=1,me={requiredFeatures:[],powerPreference:"high-performance"},Ce={workgroupSize:256,candidateCapacityPerDispatch:4096},ft=K*Uint32Array.BYTES_PER_ELEMENT,mt=4294967295,ge={mobile:1,integrated:2,discrete:4,unknown:1},gt=1,pe=8;function De(){return typeof navigator<"u"&&typeof navigator.gpu<"u"}const pt=De;async function Te(e){if(!De())throw new Error("WebGPU is not available in this environment");const r=await navigator.gpu.requestAdapter({powerPreference:me.powerPreference});if(!r)throw new Error("Failed to acquire WebGPU adapter");const n={requiredFeatures:me.requiredFeatures,requiredLimits:e?.requiredLimits,label:"seed-search-device"},[a,o]=await Promise.all([r.requestDevice(n),yt(r)]);let d=!1;const i=a.lost.then(p=>(d=!0,console.warn("[webgpu] device lost:",p.message),p)),c=ht(r,a),l=a.limits;return{getAdapter:()=>r,getDevice:()=>a,getQueue:()=>a.queue,getLimits:()=>l,getCapabilities:()=>c,getGpuProfile:()=>o,deriveSearchJobLimits:p=>_t(c.limits,o,p),isLost:()=>d,waitForLoss:()=>i,getSupportedWorkgroupSize:p=>Me(c.limits,p)}}function ht(e,t){const r=new Set;return e.features.forEach(n=>r.add(n)),{limits:t.limits,features:r}}function _t(e,t,r){const n={...Ce,...r},a=Mt(n),o=Me(e,a.workgroupSize),d=ee(e.maxComputeWorkgroupsPerDimension),i=a.maxWorkgroupsPerDispatch??d,c=Math.max(1,Math.floor(mt/Math.max(1,o))),l=V(Math.min(i,d,c),"maxWorkgroupsPerDispatch"),p=o*l,_=a.maxMessagesPerDispatch??p,w=V(Math.min(_,p),"maxMessagesPerDispatch"),b=Math.max(1,Math.floor(ee(e.maxStorageBufferBindingSize)/ft)),P=a.candidateCapacityPerDispatch??b,C=V(Math.min(P,b),"candidateCapacityPerDispatch"),E=St(t,a);return{workgroupSize:o,maxWorkgroupsPerDispatch:l,maxMessagesPerDispatch:w,candidateCapacityPerDispatch:C,maxDispatchesInFlight:E}}function Me(e,t){const r=Ce.workgroupSize,n=typeof t=="number"&&Number.isFinite(t)&&t>0?Math.floor(t):r,a=ee(e.maxComputeWorkgroupSizeX),o=ee(e.maxComputeInvocationsPerWorkgroup),d=Math.max(1,Math.min(a,o));return Math.max(1,Math.min(n,d))}function ee(e){return typeof e!="number"||!Number.isFinite(e)||e<=0?Number.MAX_SAFE_INTEGER:Math.floor(e)}function V(e,t){if(!Number.isFinite(e)||e<=0)throw new Error(`${t} must be a positive finite number`);return Math.floor(e)}function St(e,t){if(typeof t.maxDispatchesInFlight=="number")return V(Math.min(t.maxDispatchesInFlight,pe),"maxDispatchesInFlight");const r=e.isFallbackAdapter?gt:ge[e.kind]??ge.unknown;return V(Math.min(r,pe),"maxDispatchesInFlight")}async function yt(e){const t=wt(),n=!!e.isFallbackAdapter,a=Pt();if(a){const o={description:a.renderer};return{kind:a.kind,source:"webgl",userAgent:t,adapterInfo:o,isFallbackAdapter:n}}return n?{kind:"integrated",source:"fallback",userAgent:t,adapterInfo:void 0,isFallbackAdapter:n}:{kind:"unknown",source:"unknown",userAgent:t,adapterInfo:void 0,isFallbackAdapter:n}}function wt(){return typeof navigator>"u"?"":navigator.userAgent||""}const xt=["mali","adreno","powervr","apple gpu","apple m","snapdragon","exynos"],Rt=["nvidia","geforce","rtx","gtx","quadro","amd","radeon rx","radeon pro","arc"],bt=["intel","iris","uhd","hd graphics","radeon graphics","apple"];function oe(e,t){return t.some(r=>e.includes(r))}function Et(e){if(!e)return;const t=e.toLowerCase();if(oe(t,xt))return"mobile";if(oe(t,Rt))return"discrete";if(oe(t,bt))return"integrated"}function Pt(){const e=Ct();if(!e)return;const t=Et(e);if(t)return{kind:t,renderer:e}}function Ct(){const e=Dt();if(e)try{const t=Tt(e);if(!t)return;const r=t.getExtension("WEBGL_debug_renderer_info");if(!r)return;const n=t.getParameter(r.UNMASKED_RENDERER_WEBGL),a=t.getExtension("WEBGL_lose_context");return a&&a.loseContext(),typeof n=="string"?n:void 0}catch(t){console.warn("[webgpu] webgl renderer detection failed:",t);return}}function Dt(){if(typeof OffscreenCanvas<"u")return new OffscreenCanvas(1,1);if(typeof document<"u"&&typeof document.createElement=="function"){const e=document.createElement("canvas");return e.width=1,e.height=1,e}}function Tt(e){const t=e,r=t.getContext;if(typeof r!="function")return null;const n=a=>r.call(t,a)??null;return n("webgl2")??n("webgl")}function Mt(e,t){return e}var vt=`const WORKGROUP_SIZE : u32 = WORKGROUP_SIZE_PLACEHOLDERu;\r
\r
...
}`;const Bt=/WORKGROUP_SIZE_PLACEHOLDER/g,Ot="seed-search-kernel-module",At="seed-search-kernel",kt="seed-search-kernel-layout",Lt="seed-search-kernel-bind-layout";function Ut(e){return vt.replace(Bt,String(e))}function It(e,t){const r=e.createShaderModule({label:Ot,code:Ut(t)});r.getCompilationInfo?.().then(d=>{d.messages.length>0&&console.warn("[seed-search-kernel] compilation diagnostics",d.messages.map(i=>({message:i.message,line:i.lineNum,column:i.linePos,type:i.type})))}).catch(d=>{console.warn("[seed-search-kernel] compilation info failed",d)});const n=e.createBindGroupLayout({label:Lt,entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,buffer:{type:"read-only-storage"}},{binding:1,visibility:GPUShaderStage.COMPUTE,buffer:{type:"uniform"}},{binding:2,visibility:GPUShaderStage.COMPUTE,buffer:{type:"read-only-storage"}},{binding:3,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}}]}),a=e.createPipelineLayout({label:kt,bindGroupLayouts:[n]});return{pipeline:e.createComputePipeline({label:At,layout:a,compute:{module:r,entryPoint:"sha1_generate"}}),layout:n}}const Ft=4,he=256,se=new Uint32Array([0]);function ve(e,t){const r={context:t??null,pipeline:null,bindGroupLayout:null,targetBuffer:null,targetCapacity:0,workgroupSize:0,candidateCapacity:0,currentLimits:null,dispatchSlots:[],availableSlots:[],slotWaiters:[],desiredDispatchSlots:1},n=async(s,g)=>{r.context||(r.context=await Te());const u=r.context.getDevice(),f=r.context.getSupportedWorkgroupSize(s.workgroupSize),h=Math.max(1,g?.dispatchSlots??r.desiredDispatchSlots??1),m=!r.currentLimits||r.workgroupSize!==f||r.candidateCapacity!==s.candidateCapacityPerDispatch;if(!r.pipeline||m){const{pipeline:y,layout:x}=It(u,f);r.pipeline=y,r.bindGroupLayout=x}r.workgroupSize=f,r.candidateCapacity=s.candidateCapacityPerDispatch,r.currentLimits=s,r.desiredDispatchSlots=h,a(u,h,s.candidateCapacityPerDispatch),r.currentLimits=s},a=(s,g,u)=>{for(const f of r.dispatchSlots)c(s,f,u);for(;r.dispatchSlots.length<g;){const f=r.dispatchSlots.length,h=o(s,f,u);r.dispatchSlots.push(h)}for(;r.dispatchSlots.length>g;){const f=r.dispatchSlots.pop();f&&l(f)}r.availableSlots=[...r.dispatchSlots],r.slotWaiters.length=0},o=(s,g,u)=>{const f=new Uint32Array(Ft),h=Y(f.byteLength),m=s.createBuffer({label:`seed-search-dispatch-state-${g}`,size:h,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST}),{matchOutputBuffer:S,readbackBuffer:y,matchBufferSize:x}=i(s,u,g);return{id:g,dispatchStateBuffer:m,dispatchStateData:f,uniformBuffer:null,uniformCapacityWords:0,matchOutputBuffer:S,readbackBuffer:y,matchBufferSize:x}},d=(s,g,u)=>{const f=Y(u*Uint32Array.BYTES_PER_ELEMENT);(!g.uniformBuffer||g.uniformCapacityWords<u)&&(g.uniformBuffer?.destroy(),g.uniformBuffer=s.createBuffer({label:`seed-search-uniform-${g.id}`,size:f,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),g.uniformCapacityWords=u)},i=(s,g,u)=>{const f=j+g*K,h=Y(f*Uint32Array.BYTES_PER_ELEMENT),m=s.createBuffer({label:`seed-search-output-${u}`,size:h,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_SRC|GPUBufferUsage.COPY_DST}),S=s.createBuffer({label:`seed-search-readback-${u}`,size:h,usage:GPUBufferUsage.MAP_READ|GPUBufferUsage.COPY_DST});return{matchOutputBuffer:m,readbackBuffer:S,matchBufferSize:h}},c=(s,g,u)=>{const f=j+u*K,h=Y(f*Uint32Array.BYTES_PER_ELEMENT);if(g.matchBufferSize===h)return;g.matchOutputBuffer.destroy(),g.readbackBuffer.destroy();const m=i(s,u,g.id);g.matchOutputBuffer=m.matchOutputBuffer,g.readbackBuffer=m.readbackBuffer,g.matchBufferSize=m.matchBufferSize},l=s=>{s.dispatchStateBuffer.destroy(),s.uniformBuffer?.destroy(),s.matchOutputBuffer.destroy(),s.readbackBuffer.destroy()},p=()=>r.availableSlots.length>0?Promise.resolve(r.availableSlots.pop()):new Promise(s=>{r.slotWaiters.push(s)}),_=s=>{const g=r.slotWaiters.shift();if(g){g(s);return}r.availableSlots.push(s)};return{ensureConfigured:n,setTargetSeeds:s=>{if(!r.context)throw new Error("SeedSearchEngine is not configured yet");const g=r.context.getDevice(),u=s.length,f=1+u,h=Y(f*Uint32Array.BYTES_PER_ELEMENT);(!r.targetBuffer||r.targetCapacity<u)&&(r.targetBuffer?.destroy(),r.targetBuffer=g.createBuffer({label:"seed-search-target-seeds",size:h,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST}),r.targetCapacity=u);const m=new Uint32Array(f);m[0]=u>>>0;for(let S=0;S<u;S+=1)m[1+S]=s[S]>>>0;g.queue.writeBuffer(r.targetBuffer,0,m.buffer,m.byteOffset,m.byteLength)},executeSegment:async s=>{if(!r.context||!r.pipeline||!r.bindGroupLayout)throw new Error("SeedSearchEngine is not ready");if(!r.targetBuffer)throw new Error("Target seed buffer is not prepared");if(r.dispatchSlots.length===0)throw new Error("Dispatch slots are not configured");const g=r.context.getDevice(),u=g.queue,f=Math.max(1,s.workgroupCount),h=f,m=await p();try{const S=q();u.writeBuffer(m.matchOutputBuffer,0,se.buffer,se.byteOffset,se.byteLength);const y=m.dispatchStateData;y[0]=s.messageCount>>>0,y[1]=s.baseSecondOffset>>>0,y[2]=r.candidateCapacity>>>0,y[3]=0,u.writeBuffer(m.dispatchStateBuffer,0,y.buffer,y.byteOffset,y.byteLength);const x=s.getUniformWords();d(g,m,x.length),u.writeBuffer(m.uniformBuffer,0,x.buffer,x.byteOffset,x.byteLength);const B=q(),D=g.createBindGroup({label:`seed-search-bind-group-${s.id}-slot-${m.id}`,layout:r.bindGroupLayout,entries:[{binding:0,resource:{buffer:m.dispatchStateBuffer}},{binding:1,resource:{buffer:m.uniformBuffer}},{binding:2,resource:{buffer:r.targetBuffer}},{binding:3,resource:{buffer:m.matchOutputBuffer}}]}),R=g.createCommandEncoder({label:`seed-search-encoder-${s.id}`}),O=R.beginComputePass({label:`seed-search-pass-${s.id}`});O.setPipeline(r.pipeline),O.setBindGroup(0,D),O.dispatchWorkgroups(f),O.end(),R.copyBufferToBuffer(m.matchOutputBuffer,0,m.readbackBuffer,0,m.matchBufferSize);const U=R.finish();u.submit([U]),await m.readbackBuffer.mapAsync(GPUMapMode.READ,0,m.matchBufferSize);const A=q(),re=m.readbackBuffer.getMappedRange(0,m.matchBufferSize),F=new Uint32Array(re.slice(0));m.readbackBuffer.unmap();const W=q(),$=F[0]??0,z=Math.min($,r.candidateCapacity),ne=Math.min(F.length,j+z*K),J={words:F.slice(0,ne),matchCount:z};return e?.onDispatchComplete?.({segmentId:s.id,messageCount:s.messageCount,workgroupCount:h,matchCount:z,candidateCapacity:r.candidateCapacity,timings:{totalMs:W-S,setupMs:B-S,gpuMs:A-B,readbackMs:W-A},timestampMs:W}),J}finally{_(m)}},dispose:()=>{for(const s of r.dispatchSlots)l(s);r.dispatchSlots=[],r.availableSlots=[],r.slotWaiters.length=0,r.targetBuffer?.destroy(),r.context=null,r.pipeline=null,r.bindGroupLayout=null,r.targetBuffer=null,r.targetCapacity=0,r.currentLimits=null},getWorkgroupSize:()=>r.workgroupSize,getCandidateCapacity:()=>r.candidateCapacity,getSupportedLimits:()=>r.context?.getLimits()??null}}function Y(e){return Math.ceil(e/he)*he}function q(){return typeof performance<"u"?performance.now():Date.now()}const Wt=1024,zt=500;function Gt(e){const t=new lt,r=e??ve(),n={isRunning:!1,isPaused:!1,shouldStop:!1,job:null,progress:null,callbacks:null,timer:{cumulativeRunTime:0,segmentStartTime:0,isPaused:!1},lastProgressUpdate:0},a=async(u,f,h)=>{if(n.isRunning)throw new Error("Seed search is already running");n.isRunning=!0,n.isPaused=!1,n.shouldStop=h?.aborted??!1,n.job=u,n.callbacks=f,n.lastProgressUpdate=0,n.progress={currentStep:0,totalSteps:u.summary.totalMessages,elapsedTime:0,estimatedTimeRemaining:0,matchesFound:0,currentDateTime:u.timePlan?new Date(u.timePlan.startDayTimestampMs).toISOString():void 0},b(),_(!1);let m;if(h){const S=()=>{n.shouldStop=!0};h.addEventListener("abort",S),m=()=>h.removeEventListener("abort",S),n.abortCleanup=m}try{if(u.summary.totalMessages===0){f.onComplete("探索対象の組み合わせが存在しません");return}const S=Math.max(1,Math.min(u.limits.maxDispatchesInFlight??1,u.segments.length||1));await r.ensureConfigured(u.limits,{dispatchSlots:S}),r.setTargetSeeds(u.targetSeeds);const y=new Set,x=new Set,B=D=>{const R=(async()=>{if(n.shouldStop)return;const{words:O,matchCount:U}=await r.executeSegment(D);if(n.shouldStop)return;const A=(async()=>{await d(D,O,U)})();x.add(A),A.finally(()=>x.delete(A))})();y.add(R),R.finally(()=>y.delete(R))};for(const D of u.segments){if(n.shouldStop||(await p(),n.shouldStop))break;B(D),y.size>=S&&await Promise.race(y)}y.size>0&&await Promise.all(y),x.size>0&&await Promise.all(x),o()}catch(S){const y=S instanceof Error?S.message:"WebGPU検索中に不明なエラーが発生しました",x=globalThis.GPUValidationError,B=x&&S instanceof x?"WEBGPU_VALIDATION_ERROR":void 0;throw f.onError(y,B),S}finally{m?.(),n.abortCleanup=void 0,n.isRunning=!1,n.isPaused=!1,E(),n.job=null,n.callbacks=null,n.progress=null,n.shouldStop=!1,n.lastProgressUpdate=0}},o=()=>{const u=n.callbacks,f=n.progress;if(!(!u||!f)){if(w(f),n.shouldStop){u.onStopped("検索を停止しました",f);return}u.onProgress(f),u.onComplete(`検索が完了しました。${f.matchesFound}件ヒットしました。`)}},d=async(u,f,h)=>{const m=n.job,S=n.callbacks,y=n.progress;if(!m||!S||!y)return;const x=j,B=K;for(let D=0;D<h&&!(n.shouldStop||D%Wt===0&&(await p(),n.shouldStop));D+=1){const R=x+D*B,O=f[R],U=f[R+1]>>>0,A=u.globalMessageOffset+O,re=u.baseSecondOffset+O,F=u.timer0,W=u.vcount,$=de(m.timePlan,re),z=t.generateMessage(m.conditions,F,W,$,u.keyCode),{hash:ne,seed:J,lcgSeed:Ae}=t.calculateSeed(z);J!==U&&console.warn("GPU/CPU seed mismatch detected",{gpuSeed:U,cpuSeed:J,messageIndex:A});const ke={seed:U,datetime:$,timer0:F,vcount:W,keyCode:u.keyCode,conditions:m.conditions,message:z,sha1Hash:ne,lcgSeed:Ae,isMatch:!0};S.onResult(ke),y.matchesFound+=1}if(u.messageCount>0){const D=u.messageCount-1,R=u.baseSecondOffset+D;y.currentDateTime=de(m.timePlan,R).toISOString()}y.currentStep+=u.messageCount,_(!0)},i=()=>{!n.isRunning||n.isPaused||(n.isPaused=!0,P(),n.callbacks?.onPaused())},c=()=>{!n.isRunning||!n.isPaused||(n.isPaused=!1,C(),n.callbacks?.onResumed())},l=()=>{n.isRunning&&(n.shouldStop=!0,n.isPaused=!1,C())},p=async()=>{for(;n.isPaused&&!n.shouldStop;)await g(25)},_=u=>{const f=n.callbacks,h=n.progress;if(!f||!h)return;const m=Date.now();u&&h.currentStep<h.totalSteps&&m-n.lastProgressUpdate<zt||(w(h),f.onProgress(h),n.lastProgressUpdate=m)},w=u=>{const f=v();u.elapsedTime=f,u.estimatedTimeRemaining=s(u.currentStep,u.totalSteps,f)},b=()=>{n.timer.cumulativeRunTime=0,n.timer.segmentStartTime=Date.now(),n.timer.isPaused=!1},P=()=>{n.timer.isPaused||(n.timer.cumulativeRunTime+=Date.now()-n.timer.segmentStartTime,n.timer.isPaused=!0)},C=()=>{n.timer.isPaused&&(n.timer.segmentStartTime=Date.now(),n.timer.isPaused=!1)},E=()=>{n.timer.isPaused||(n.timer.cumulativeRunTime+=Date.now()-n.timer.segmentStartTime,n.timer.isPaused=!0)},v=()=>n.timer.isPaused?n.timer.cumulativeRunTime:n.timer.cumulativeRunTime+(Date.now()-n.timer.segmentStartTime),s=(u,f,h)=>{if(u===0||u>=f)return 0;const m=h/u;return Math.round(m*(f-u))},g=u=>new Promise(f=>setTimeout(f,u));return{run:a,pause:i,resume:c,stop:l}}const Be=self,Nt=3n,_e=0x100000000n,M={isRunning:!1,isPaused:!1};let I=null,te=null,ue=null,X=null;function Yt(e,t){if(t<=0||e.maxMessagesPerDispatch<=0)return e.candidateCapacityPerDispatch;const r=Nt*BigInt(e.maxMessagesPerDispatch)*BigInt(t),n=Number((r+_e-1n)/_e);return Math.max(1,n)}async function Oe(){return ue||(ue=Te()),ue}async function Ht(){if(I)return I;const e=await Oe(),t=ve(void 0,e);return I=Gt(t),I}async function Kt(){return X||(X=(await Oe()).deriveSearchJobLimits(),X)}function T(e){Be.postMessage(e)}function Vt(){T({type:"READY",message:"WebGPU worker initialized"})}function H(){M.isRunning=!1,M.isPaused=!1,te=null}function $t(){return pt()?!0:(T({type:"ERROR",error:"WebGPU is not supported in this environment",errorCode:"WEBGPU_UNSUPPORTED"}),!1)}async function Jt(e){if(M.isRunning){T({type:"ERROR",error:"Search is already running"});return}if(!e.conditions||!e.targetSeeds){T({type:"ERROR",error:"Missing conditions or target seeds"});return}if(!$t())return;M.isRunning=!0,M.isPaused=!1;let t,r;try{const[a,o]=await Promise.all([Kt(),Ht()]),d=Yt(a,e.targetSeeds.length),i={...a,candidateCapacityPerDispatch:Math.min(a.candidateCapacityPerDispatch,d)};t=Ke(e.conditions,e.targetSeeds,{limits:i}),r=o}catch(a){H();const o=a instanceof Error?a.message:"検索条件の解析中にエラーが発生しました";T({type:"ERROR",error:o,errorCode:"WEBGPU_CONTEXT_ERROR"});return}te=new AbortController;const n={onProgress:a=>{T({type:"PROGRESS",progress:a})},onResult:a=>{T({type:"RESULT",result:a})},onComplete:a=>{H(),T({type:"COMPLETE",message:a})},onError:(a,o)=>{H(),T({type:"ERROR",error:a,errorCode:o})},onPaused:()=>{M.isPaused=!0,T({type:"PAUSED"})},onResumed:()=>{M.isPaused=!1,T({type:"RESUMED"})},onStopped:(a,o)=>{H(),T({type:"STOPPED",message:a,progress:o})}};try{await r.run(t,n,te.signal)}catch(a){if(!M.isRunning)return;H();const o=a instanceof Error?a.message:"WebGPU search failed with unknown error";T({type:"ERROR",error:o,errorCode:"WEBGPU_RUNTIME_ERROR"})}}function qt(){!M.isRunning||M.isPaused||I?.pause()}function Xt(){!M.isRunning||!M.isPaused||I?.resume()}function Zt(){M.isRunning&&(I?.stop(),te?.abort())}Vt();Be.onmessage=e=>{const t=e.data;switch(t.type){case"START_SEARCH":Jt(t);break;case"PAUSE_SEARCH":qt();break;case"RESUME_SEARCH":Xt();break;case"STOP_SEARCH":Zt();break;default:T({type:"ERROR",error:`Unknown request type: ${t.type}`})}};
